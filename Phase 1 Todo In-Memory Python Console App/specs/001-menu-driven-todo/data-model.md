# Data Model: Menu-Driven Todo CLI Application

## Task Entity

### Fields
- **id** (string): Zero-padded numeric identifier assigned automatically to each task (e.g., "001", "002", "003")
...
### Validation Rules
- id: Must be unique, auto-generated, zero-padded format (e.g., "001", "002")
...
- **tasks** (dictionary): Dictionary keyed by task ID containing Task objects
  - Key: task ID (string, zero-padded format)
  - Value: Task object with {id, title, description, completed}

### Operations
- Add: Insert new task object into dictionary with unique zero-padded ID as key
